  ...
  return (
    <Flex flexDirection="column">
      <Text fontSize="md" fontWeight="700" mb="0.5">
        {isBase ? 'Claim USDC' : `Claim ${stablecoin?.symbol}`}
      </Text>
      ...
      <Alert colorScheme="blue" mb="4">
        <Text fontWeight="semibold">
          As a security precaution, claimed assets can only be withdrawn to your wallet after 24 hs
          since your previous account activity.
        </Text>
      </Alert>

      <Button data-testid="claim submit" type="submit">
        Claim
      </Button>
    </Flex>
  );
...
export const Claim = ({ liquidityPosition }: { liquidityPosition?: LiquidityPosition }) => {
  ...
  return <ClaimUi setDebtChange={setDebtChange} debtChange={debtChange} maxDebt={maxDebt} />;
};
