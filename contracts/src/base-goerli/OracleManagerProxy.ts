...
export const address = '0xbAbfb6e9f914C1EfBBFFAdeE6cd86B23927434C8';
export const abi = [
  ...
  'function registerNode(uint8 nodeType, bytes parameters, bytes32[] parents) payable returns (bytes32 nodeId)',
];
