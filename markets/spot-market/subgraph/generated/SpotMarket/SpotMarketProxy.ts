...
export class SynthBought__Params {
  ...
  get fees(): SynthBoughtFeesStruct {
    return changetype<SynthBoughtFeesStruct>(
...
export class SynthSold__Params {
  ...
  get fees(): SynthSoldFeesStruct {
    return changetype<SynthSoldFeesStruct>(
      this._event.parameters[2].value.toTuple()
    );
  }
...
export class OrderSettled__Params {
  ...
  get fees(): OrderSettledFeesStruct {
    return changetype<OrderSettledFeesStruct>(
...
export class SynthUnwrapped__Params {
  ...
  get fees(): SynthUnwrappedFeesStruct {
    return changetype<SynthUnwrappedFeesStruct>(
      this._event.parameters[2].value.toTuple()
    );
  }
...
export class SynthWrapped__Params {
  ...
  get fees(): SynthWrappedFeesStruct {
    return changetype<SynthWrappedFeesStruct>(
      this._event.parameters[2].value.toTuple()
    );
  }
...
export class SpotMarketProxy extends ethereum.SmartContract {
  ...
  createSynth(
    ...
    let result = super.call(
      "createSynth",
      "createSynth(string,string,address):(uint128)",
      [
  ...
  try_getAssociatedSystem(
    ...
    return ethereum.CallResult.fromValue(
      new SpotMarketProxy__getAssociatedSystemResult(
        value[0].toAddress(),
        value[1].toBytes()
      )
    );
  ...
  buyExactIn(
    ...
    return new SpotMarketProxy__buyExactInResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__buyExactInResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  buyExactOut(
    ...
    return new SpotMarketProxy__buyExactOutResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__buyExactOutResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  quoteBuyExactIn(
    ...
    return new SpotMarketProxy__quoteBuyExactInResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__quoteBuyExactInResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  quoteBuyExactOut(
    ...
    return new SpotMarketProxy__quoteBuyExactOutResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__quoteBuyExactOutResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  quoteSellExactIn(
    ...
    return new SpotMarketProxy__quoteSellExactInResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__quoteSellExactInResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  quoteSellExactOut(
    ...
    return new SpotMarketProxy__quoteSellExactOutResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__quoteSellExactOutResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  sellExactIn(
    ...
    return new SpotMarketProxy__sellExactInResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__sellExactInResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  sellExactOut(
    ...
    return new SpotMarketProxy__sellExactOutResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__sellExactOutResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  commitOrder(
    ...
    return changetype<SpotMarketProxy__commitOrderResultAsyncOrderClaimStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_commitOrder(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<SpotMarketProxy__commitOrderResultAsyncOrderClaimStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getAsyncOrderClaim(
    ...
    let result = super.call(
      ...
      [
        ethereum.Value.fromUnsignedBigInt(marketId),
        ethereum.Value.fromUnsignedBigInt(asyncOrderId),
      ]
    );
  ...
  try_getAsyncOrderClaim(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<SpotMarketProxy__getAsyncOrderClaimResultAsyncOrderClaimStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  settleOrder(
    marketId: BigInt,
    asyncOrderId: BigInt
  ): SpotMarketProxy__settleOrderResult {
    let result = super.call(
      "settleOrder",
    ...
    return new SpotMarketProxy__settleOrderResult(
      result[0].toBigInt(),
      changetype<SpotMarketProxy__settleOrderResultFeesStruct>(
        result[1].toTuple()
      )
    );
  }
  ...
  getFeeCollector(synthMarketId: BigInt): Address {
    let result = super.call(
      "getFeeCollector",
      "getFeeCollector(uint128):(address)",
      [ethereum.Value.fromUnsignedBigInt(synthMarketId)]
    );
  ...
  getMarketSkewScale(synthMarketId: BigInt): BigInt {
    let result = super.call(
      "getMarketSkewScale",
      "getMarketSkewScale(uint128):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(synthMarketId)]
    );
  ...
  getReferrerShare(synthMarketId: BigInt, referrer: Address): BigInt {
    let result = super.call(
      "getReferrerShare",
      "getReferrerShare(uint128,address):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(synthMarketId),
        ethereum.Value.fromAddress(referrer),
      ]
...
export class BuyCall__Outputs {
  ...
  get fees(): BuyCallFeesStruct {
    return changetype<BuyCallFeesStruct>(
...
export class BuyExactInCall__Outputs {
  ...
  get fees(): BuyExactInCallFeesStruct {
    return changetype<BuyExactInCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class BuyExactOutCall__Outputs {
  ...
  get fees(): BuyExactOutCallFeesStruct {
    return changetype<BuyExactOutCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class SellCall__Outputs {
  ...
  get fees(): SellCallFeesStruct {
    return changetype<SellCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class SellExactInCall__Outputs {
  ...
  get fees(): SellExactInCallFeesStruct {
    return changetype<SellExactInCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class SellExactOutCall__Outputs {
  ...
  get fees(): SellExactOutCallFeesStruct {
    return changetype<SellExactOutCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class SettleOrderCall__Outputs {
  ...
  get fees(): SettleOrderCallFeesStruct {
    return changetype<SettleOrderCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class SettlePythOrderCall__Outputs {
  ...
  get fees(): SettlePythOrderCallFeesStruct {
    return changetype<SettlePythOrderCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class UnwrapCall__Outputs {
  ...
  get fees(): UnwrapCallFeesStruct {
    return changetype<UnwrapCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
...
export class WrapCall__Outputs {
  ...
  get fees(): WrapCallFeesStruct {
    return changetype<WrapCallFeesStruct>(
      this._call.outputValues[1].value.toTuple()
    );
  }
}
